...
var augmentValueByEvent = function(company, activityObject) {
  ...
  if(activityObject.what == 'dilution') {
    var newSharePool = company.total_investments/activityObject.value;
    newSharePool += parseInt(activityObject.raw_value);
    // Just doing something
    var dillutedValue = company.total_investments/newSharePool;
    activityObject.value += (activityObject.value - dillutedValue);
  }
};
